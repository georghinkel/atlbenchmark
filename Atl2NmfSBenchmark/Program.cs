...
namespace NMF.Synchronizations.ATLBenchmark
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (args[0] == "Make2Ant")
            {
                Make2AntExecutor.Measure(sizes: new[] { 10, 50, 100, 500, 1000, 5000, 10000, 50000 }, iterations: 1, workloadSize: 20);
            }
            else if (args[0] == "Families2Persons")
            {
                Families2PersonsExecuter.Measure(sizes: new[] { 10, 50, 100, 500, 1000, 5000, 10000, 50000 }, iterations: 1, workloadSize: 20);
            }
